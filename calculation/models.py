...
class CalculationPeriod(models.Model):
    group_id = models.ForeignKey(Groups, on_delete=models.CASCADE, related_name='calculation_cycle_group')
...
class Expenses(models.Model):
    calculation_period = models.ForeignKey(CalculationPeriod, on_delete=models.CASCADE, related_name='cal_period',
                                           null=True)
    group_id = models.ForeignKey(Groups, on_delete=models.CASCADE, related_name='exp_of_group')
    spender = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='spender')
...
class PersonalTotal(models.Model):
    ...
    group_id = models.ForeignKey(Groups, on_delete=models.CASCADE, related_name='group_personal_total')
    spender_id = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='spender_id_personal')
...
class FinalTransaction(models.Model):
    ...
    group_id = models.ForeignKey(Groups, on_delete=models.CASCADE, related_name='group_final_transaction')
    amount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
